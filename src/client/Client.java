    ...
    private void runMainLoop() {
        ...
        while (isRunning) {
            try {
                ...
                // Проверка: команды без аргументов
                ...
                // Проверка: команды с обязательными аргументами
                ...
                if (type == CommandType.SHOW) {
                    ...
                    if (response == null) {
                        System.err.println("Сервер не ответил. Проверьте подключение.");
                        continue;
                    }
                ...
                // Скрытая команда never (Rickroll)
                if (type == CommandType.NEVER) {
                    Never neverCommand = new Never();
                    neverCommand.execute(socket, networkManager, serverHost, serverPort);
                    continue;
                }
